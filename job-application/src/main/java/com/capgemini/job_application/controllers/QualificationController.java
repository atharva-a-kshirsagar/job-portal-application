...
public class QualificationController {
	...
	@PostMapping
	public ResponseEntity<Qualification> createQualification(@Valid @RequestBody Qualification qualification, BindingResult result){
		if(result.hasErrors()) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Qualification> updateQualification(@PathVariable Long id, @Valid @RequestBody Qualification qualification, BindingResult result){
		if(result.hasErrors()) {
			throw new IllegalArgumentException("Invalid Data Found");
		}
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Qualification> patchQualification(@PathVariable Long id, @Valid @RequestBody Qualification qualification, BindingResult result){
		if(result.hasErrors()) {
			throw new IllegalArgumentException("Invalid Data Found");
		}
